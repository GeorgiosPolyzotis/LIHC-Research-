...
```{r}
brca = read.table("full_BRCA_miR_data.txt",header = T,row.names = 1, stringsAsFactors = F)
```
...
brcasig = cbind.data.frame(Condition,brcasig)
```
